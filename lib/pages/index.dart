    ...
    return WillPopScope(
      ...
      /// RECENT EXEATS HERE
                              ...
                              return InkWell(
                                ...
                                child: Padding(
                                  ...
                                  child: Badge(
                                    ...
                                    label: Row(
                                      children: [
                                        Text(student.isBack ? 'Signed In ' : 'Signed Out', style: TextStyle(color: Colors.white, fontSize: 10.sp,fontFamily: 'QuickSand',fontWeight: FontWeight.bold),),
                                        const SizedBox(width: 10,),
                                        Text('KEY : ${student.id}', style: TextStyle(color: Colors.white, fontSize: 12.sp,fontWeight: FontWeight.bold,fontFamily: 'QuickSand',letterSpacing: 1),),
                                      ],
                                    ),
                                    backgroundColor: student.isBack ? Colors.green : Colors.red,
                                    child: ExpansionTile(
                                      collapsedShape: RoundedRectangleBorder(
                                        side:  BorderSide( color: student.isBack?Colors.green : Colors.red,width: 2),
                                        borderRadius: BorderRadius.circular(10),
                                      ),
                                      shape: RoundedRectangleBorder(
                                        side: BorderSide(color: student.isBack?Colors.green : Colors.red, width: 1),
                                        borderRadius: BorderRadius.circular(20),
                                      ),
                                            ...
                                            children: [
                                              LiteRollingSwitch(
                                                ...
                                                onChanged: (bool state) {
                                                  Provider.of<LocalStorageProvider>(context, listen: false).updateIsBackStatus(index, state);
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: Center(
                                                    child: Padding(
                                                      ...
                                                      child: Text('Delete Exeat', style: TextStyle(color: Colors.white,fontSize: 12.sp,fontFamily: "QuickSand",fontWeight: FontWeight.bold),),
                                                    ),
                                                  ),
                                                ),
                                              )
        ...
        floatingActionButton: GestureDetector(
          onTap: (){
            Provider.of<KeyFunctions>(context, listen: false).generateRandomString();
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            //Generate a random 5 number for the id

                            if (formKey.currentState!.validate()) {

                              Provider.of<LocalStorageProvider>(context, listen: false).addExeat(
                                SignExeatModel(
                                  id:Provider.of<KeyFunctions>(context, listen: false).AuthKey,
                                ...
                                Provider.of<NotificationProvider>(context,listen:false).sendSms(_parentTellController.text,
                                   ...
                                   Provider.of<LocalStorageProvider>(context, listen: false).sendSmsToSecurity(
                                       context,
                                       Provider.of<KeyFunctions>(context, listen: false).AuthKey,
          ...
          child: Container(
            ...
            child: Center(
              child: Padding(
                padding: const EdgeInsets.all(4.0),
                child: Text('Approve Exeat +', style: TextStyle(color: Colors.white,fontSize: 8.sp,fontFamily: "QuickSand",fontWeight: FontWeight.bold),),
              ),
            ),
          ),
        )
